...
namespace Jt.Application.Utility.Results;
public partial class BasicResult
{
    ...
    public override string ToString()
    {
        ...
        if (Exception != null)
            sb.AppendLine($"{nameof(Exception)}: {Exception.Message}{Environment.NewLine}{Exception.StackTrace}");
        if (Exception?.InnerException != null)
            sb.AppendLine($"{nameof(Exception.InnerException)}: {Exception.Message}{Environment.NewLine}{Exception.StackTrace}");
